    ...
    properties: {
      receitas: {
        ...
        items: {
          type: "object",
          properties: {
            nome: { type: "string", description: "Nome do prato, em português (traduza se a fonte estiver em outro idioma)." },
            categoria: {
              type: "string",
            ...
            ingredientes: {
              ...
              items: {
                type: "object",
                properties: {
                  nome: { type: "string", description: "Nome do ingrediente, em português (traduza se a fonte estiver em outro idioma)." },
